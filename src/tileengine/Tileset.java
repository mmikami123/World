...
public class Tileset implements Serializable {
    ...
    public static final TETile WALL = new TETile('#', new Color(216, 128, 128), Color.darkGray,
            "wall", 1);
    public static final TETile FLOOR = new TETile('·', Color.pink, Color.black, "floor", 2);
    ...
    public static final TETile HEART = new TETile('♥', new Color(166, 143, 207),
            new Color(36, 22, 125),"heart", 13);
    public static final TETile HOUSE = new TETile('⌂', new Color(38, 43, 56),
            new Color(173, 148, 137), "house", 14);
    public static final TETile INDENT = new TETile('¶', new Color(10, 255, 59),
            new Color(255, 10, 226), "indent", 15);
}
